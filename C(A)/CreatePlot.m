%% Plot of figures in the paper for C(A).
%
...
legend('Obs TreeFM k(AB)', 'Obs BranchFM k(AB)', 'Obs BranchFM k(A)', 'Obs TreeFM k(AB) F', 'Obs TreeFM k(AB) III',... % pseudo-exact tests
    ...
    'Obs TreeFM','Obs TreeFM 2PCs','Obs BranchFM', 'Obs TreeFM F', 'Obs TreeFM III', 'Location','northeast')  % unrestricted raw

a=get(f,'Children');
set(a(1),'Fontsize',10);
set(a(2),'Fontsize',12);
saveas(gcf,'../Fig/C_TN');
saveas(gcf,'../Fig/C_TN.eps','epsc');
...
%set(a(2),'Fontsize',16);
set(a,'Fontsize',18);
saveas(gcf,'../Fig/C_TNb');
saveas(gcf,'../Fig/C_TNb.eps','epsc');