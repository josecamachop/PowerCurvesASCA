...
function e = ObsBranchFM(Xm,D,parglmo)
        ...
        SSQ_interactions(1) = sum(sum((D1(:,parglmo.interactions{1}.Dvars)*B(parglmo.interactions{1}.Dvars,:)).^2));
        ...
        for j = 1 : n_perm
            ...
            SSQ_interactions(1 + j) = sum(sum((D1(:,parglmo.interactions{1}.Dvars)*B(parglmo.interactions{1}.Dvars,:)).^2));
