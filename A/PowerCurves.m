%% Computiation of Power Curves for A
% 
...
eD = zeros(14,length(alpha),perm_tot);
reo = 3;
...
for i2=1:perm_tot
    ...
    for a = 1:length(alpha)
        ...
        eD(1,a,i2) = ObsTreeFMkBeuAB(Xm,D,parglmo,vt,vc);
        eD(2,a,i2) = ObsTreeFMkBeuC(Xm,D,parglmo,vp); 
        eD(3,a,i2) = ObsBranchFMkBeuC(Xm,D,parglmo,vp);  
        eD(4,a,i2) = ObsTreeFMkBeuCF2(Xm,D,parglmo,vp);     
        eD(5,a,i2) = ResTreeRM(Xm,D,parglmo);
        eD(6,a,i2) = ResBranchRM(Xm,D,parglmo); 
        eD(7,a,i2) = ResminRM(Xm,D,parglmo);
        eD(8,a,i2) = ResminRMeuC(Xm,D,parglmo,vp);
        eD(9,a,i2) = ResminRMF(Xm,D,parglmo);
        eD(10,a,i2) = ResminRMeuCF(Xm,D,parglmo,vp);
        eD(11,a,i2) = ObsminFMkBeuC(Xm,D,parglmo,vp);  
        eD(12,a,i2) = ObsTreeFMkBeuCF(Xm,D,parglmo,vp); 
        eD(13,a,i2) = ObsTreeFMkBeuCIII(Xm,D,parglmo,vp); 
        eD(14,a,i2) = ObsTreeFMF(Xm,D,parglmo);
